...
CREATE TABLE IF NOT EXISTS loststuff (
	...
	status SET('Lost', 'Claimed') NOT NULL DEFAULT 'Lost'
);
...
CREATE TABLE IF NOT EXISTS foundstuff (
	...
	create_date DATETIME NOT NULL,
	update_date DATETIME NOT NULL,
	status SET('Found', 'Claimed') NOT NULL DEFAULT 'Found'
);
...
INSERT INTO loststuff(item_name, description, location_name, lost_date, create_date, update_date, owner_name, phone_number, status)
	VALUES  ("Sunglasses", "Black shiny Ray-Ban sunglasses", "Hancock Center" , '2016-03-25', NOW() , NOW(), "Cool Joe","8423523544", "Lost"),
			("Bag", "Red Chanel leather bag", "Marist Boathouse", '2016-02-14', NOW() , NOW(), "Lucy" ,"6362831241", "Lost"),
			("Bottle", "White bottle with Marist logo", "St. Peter's", '2016-01-18', NOW() , NOW(), "Snoopy" , "9172472948", "Lost");
